---
title: "Strategies"
description: "The canonical strategy registry. Three keys, three asset routes."
---
...
All three are returned by [`GET /api/v1/strategies`](/developer/endpoints/list-strategies). Each has a detailed view at [`GET /api/v1/strategies/{key}`](/developer/endpoints/get-strategy).
...
There are no `coming_soon` strategies live in the registry today.
